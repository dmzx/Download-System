...
$lang = array_merge($lang, array(
	...
	'EDS_COPYRIGHT'			=> '&copy; 2009 by Die Muellers Dot Org',
	'EDS_COPYRIGHT_DMZX'	=> '&copy; 2016 by dmzx-web.net',
	'EDS_CAT_DESC'			=> 'Description',
	...
	'EDS_DISABLED'			=> 'The DM Easy Download System is currently deactivated. Please try again later.<br />If you later on still encounter the same, please inform the admin.',
	...
	'EDS_REMOVE_INSTALL'	=> '<strong>The install file still exists!</strong><br /><br />To avoid problems, you should delete the file root/install_dm_eds.php or at least rename it.',
	...
	'EDS_VERSION_CHECK'					=> 'Download system Version Check',
	'EDS_AUTHOR'						=> 'Author',
	'EDS_ANNOUNCEMENT_TOPIC'			=> 'Release Announcement',
	'EDS_CURRENT_VERSION'				=> 'Current Version',
	'EDS_DOWNLOAD_LATEST'				=> 'Download Latest Version',
	'EDS_DOWNLOAD'						=> 'Download',
	'EDS_LATEST_VERSION'				=> 'Latest Version',
...
Click <strong>%4$s</strong> to go to the download page!
...
Have fun!',
	...
	'ACP_COST_TITLE_EXPLAIN'			=> 'As it looks like, you have the Ultimate Points Mod installed. Therefore you have the possibility, to subtract %1$s for a download. Each download will have its own value.',
	...
	'ACP_FILE_TOO_BIG'					=> 'The file is bigger, than your hoster allows!',
	'ACP_FORUM_ID_ERROR'				=> 'The entered forum ID does not exist!',
	'ACP_EDS_INDEX'						=> 'DM Easy Download System',
	...
	'ACP_NEW_DOWNLOAD_SIZE'				=> 'The maximum size of the file, which is allowed by your hoster, is <strong>%1$s %2$s</strong>! Due to the upload time you might need, this value can be lower!',
	...
	'ACP_UPS_SET_POINTS'				=> 'General costs for downloads',
	...
	'ACP_USERGUIDE'						=> 'User guide',
	'ACP_USERGUIDE_EXPLAIN'				=> 'Here you will find help on using the DM Easy Download System.<br /><strong>If you have any questions, please first read this manual before you ask in the forum. We tried to answer the most common questions and informations over here!</strong>',
